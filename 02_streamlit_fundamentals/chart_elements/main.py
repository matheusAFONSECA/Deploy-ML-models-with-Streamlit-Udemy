...
df = pd.read_csv("02_streamlit_fundamentals\chart_elements\data\sample.csv")
...
# Streamlit map
geo_df = pd.read_csv("02_streamlit_fundamentals\chart_elements\data\sample_map.csv")
